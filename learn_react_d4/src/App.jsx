  ...
  return (
    <div className='parent'>
      {jobOpenings.map(function(elem){
        return <Card company={elem.companyName} logo={elem.brandLogo} dateposted={elem.datePosted} role={elem.post} tag1={elem.tag1} tag2={elem.tag2} pay={elem.pay} loc={elem.location}/>
      })};
